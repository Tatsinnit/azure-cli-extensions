...
def aks_nubesgen_default(destination='.',
                         app=None,
                         language=None,
                         create_config=None,
                         dockerfile_only=None,
                         deployment_only=None,
                         path=None):
    aks_nubesgen_cmd_default(destination, app, language, create_config, dockerfile_only, deployment_only, path)
